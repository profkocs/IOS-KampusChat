...
func showToast(message: String, font: UIFont,viewController:UIViewController) {
    ...
    titleSize.width += 20
    titleSize.height += 10
    toastLabel.frame = CGRect(x: viewController.view.frame.size.width / 2 - titleSize.width / 2, y: viewController.view.frame.size.height - 200, width: titleSize.width+10, height: titleSize.height+10)
